...
def _plot_roc(label, y_prob, file_dir):
    ...
    # plt.show()
    plt.savefig(f"{file_dir}/ROC_Curve_basehock.png")
    plt.close()
...
if __name__ == "__main__":
    for i in range(1):
        ...
        dual_stg_gini_history, _ = VFL.train(
            ...
            criterion=criterion,
            verbose=True,
            models_save_dir='Response/Review3/Checkpoints/basehock_dualstg_models.pt',
        ...
        # dual_stg_gini_history.to_csv('Response/Review3/basehock_{}.csv'.format(i))
    ...
    models_path = 'Response/Review3/Checkpoints/basehock_dualstg_models.pt'
    top_model_path = 'Response/Review3/Checkpoints/basehock_dualstg_top_model.pt'
