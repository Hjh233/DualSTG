...
if __name__ == "__main__":
    ...
    #     criterion=criterion,
    #     verbose=True,
    #     models_save_dir='Checkpoints/basehock_stg_models.pt',
    #     top_model_save_dir='Checkpoints/basehock_stg_top_model.pt',
    #     save_mask_at=100000, 
    #     freeze_top_till=0)
    ...
    # original_gate_history.to_csv('LDPLog/basehock_original_gate.csv')
    ...
    # models_path = 'Checkpoints/basehock_stg_models.pt'
    # top_model_path = 'Checkpoints/basehock_stg_top_model.pt'
    ...
    # # dual_stg_gini_history.to_csv('LDPLog/basehock_ldp_{}.csv'.format(zeta))
    ...
    models_path = 'Checkpoints/basehock_dualstg_models.pt'
    top_model_path = 'Checkpoints/basehock_dualstg_top_model.pt'
