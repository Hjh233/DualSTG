...
def _plot_roc(label, y_prob, file_dir):
    ...
    # plt.show()
    plt.savefig(f"{file_dir}/ROC_Curve_relathe.png")
    plt.close()
...
if __name__ == "__main__":
    for i in range(1):
        ...
        # dual_stg_gini_history.to_csv('Response/Review3/relathe_{}.csv'.format(i))
    ...
    models_path = 'Response/Review3/Checkpoints/relathe_dualstg_models.pt'
    top_model_path = 'Response/Review3/Checkpoints/relathe_dualstg_top_model.pt'
    ...
    results.to_csv('Response/Review3/relathe.csv')
